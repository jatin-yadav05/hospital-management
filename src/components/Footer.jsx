...
function Footer() {
  ...
  const services = [
    ...
    { name: 'Preventive Care', path: '/services#preventive' },
  ];
  ...
  const contactInfo = [
    ...
    },
    {
      ...
      text: 'contact@medicare.com',
    },
    {
      icon: <MapPinIcon className="h-5 w-5" />,
      text: '123 Medical Center Drive, NY',
    },
  ];
    ...
    <footer className="bg-gray-900 text-gray-300">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {/* About Section */}
          <div>
            <h3 className="text-white text-lg font-semibold mb-4">About MediCare</h3>
            <p className="text-gray-400 text-sm">
              Providing quality healthcare services with a focus on patient comfort and well-being. 
              Trust us with your health, as we bring together expertise and compassion.
            </p>
